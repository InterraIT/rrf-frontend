...
import { Subject, Observable, debounce, timer, switchMap, tap, map } from 'rxjs';
...
export class PositionsComponent implements OnInit {
  ...
  subjectInit() {
    this.dataListObs = this.subjectMain.pipe(
      ...
      switchMap((dataFilter: any) => this.positions.getMyAssignedPositions(this.userID, dataFilter.pageNumber, dataFilter.pageSize, dataFilter.searchByFields, dataFilter.sort,dataFilter.globalSearchPattern).pipe(
        tap((res: any) => {
