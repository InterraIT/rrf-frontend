...
@Component({
  selector: 'app-recruiter-position-details',
  templateUrl: './recruiter-position-details.component.html',
  styleUrls: ['./recruiter-position-details.component.css']
})
export class RecruiterPositionDetailsComponent implements OnInit {
  ...
  public canAddInterviewer: boolean = true;
  public canRemoveInterviewer: boolean = true;
  ...
  getPositionDetailsById(positionId:string) {
